...
if (isset($_POST["submit"])) {
    ...
    // คำสั่ง SQL สำหรับเลือกข้อมูลของผู้ใช้ที่มี username และ password ตรงกับที่รับเข้ามา
    $sql = "SELECT * FROM user WHERE username='$username' AND password='$password'";

    // ทำการ execute คำสั่ง SQL
    $result = mysqli_query($conn, $sql);

    // ตรวจสอบว่ามีผู้ใช้ที่ตรงกับ username และ password ที่รับเข้ามาหรือไม่
    if (mysqli_num_rows($result) > 0) {
        // หากมีให้สร้าง session และ redirect ไปยังหน้าหลักหรือหน้าอื่นๆ ตามที่ต้องการ
        session_start();
        $_SESSION['username'] = $username;
        header("Location: course.html"); // เปลี่ยน course.html เป็นหน้าที่ต้องการให้เข้าหลังจาก sign in สำเร็จ
    } else {
        // หากไม่พบให้แสดงข้อความแจ้งเตือน
...
<html style="font-size: 16px;" lang="en">
  ...
  <head>
    <title>Sign in - Ice Academy</title>
  ...
  <body data-path-to-root="./" data-include-products="true" class="u-body u-xl-mode" data-lang="en">
    ...
    <section class="u-clearfix u-gradient u-section-1" id="sec-8145">
      <div class="u-clearfix u-sheet u-sheet-1">
        <h2 class="u-align-center u-text u-text-custom-color-6 u-text-1">Sign in</h2>
          ...
          <div class="u-container-layout u-valign-bottom u-container-layout-1">
            <div class="u-form u-login-control u-form-1">
              <form action="#" class="u-clearfix u-form-custom-backend u-form-spacing-10 u-form-vertical u-inner-form" source="custom" name="form" style="padding: 0px;" method="post">
                ...
                <div class="u-align-left u-form-group u-form-submit u-label-top">
                  ...
                  <a href="#" class="u-active-white u-border-none u-btn u-btn-round u-btn-submit u-button-style u-custom-color-6 u-custom-font u-font-ubuntu u-hover-white u-radius-50 u-text-active-custom-color-6 u-text-hover-custom-color-6 u-btn-1">Login</a>
                </div>
            ...
            <div class="u-align-center-xs u-container-style u-expanded-width u-group u-radius u-shape-round u-white u-group-2">
              <div class="u-container-layout u-valign-middle u-container-layout-2">
                <a href="signup.php" class="u-border-1 u-border-active-custom-color-5 u-border-hover-custom-color-5 u-border-no-left u-border-no-right u-border-no-top u-btn u-button-style u-custom-font u-font-ubuntu u-login-control u-login-create-account u-none u-text-active-custom-color-5 u-text-custom-color-6 u-text-hover-custom-color-5 u-btn-2">Don't have an account?</a>
              </div>
            </div>
          </div>
        </div>
